...
\begin{itemize}
    \item \textbf{Subnormal threshold} ($\approx 138$ dB): Values exceeding this represent pressures below single-precision arithmetic limits (subnormal)
    \item \textbf{Zero-weighting threshold} (110 dB): Based on operational research, TL values above 110 dB are weighted to zero in propagation analysis \cite{doi:10.23919/OCEANS.2009.5422312}
\end{itemize}
