...
\textbf{Interpretation:} 60 significant differences detected (6.25\% of 960 values). No critical failures. Files differ but within expected numerical variability.
