/**
 * @file tl_analysis.h
 * @brief Error accumulation analysis for systematic vs random error
 *        classification in TL curve comparisons
 *
 * This module implements statistical tests to determine if errors in numerical
 ...
 * validation to replace ad-hoc threshold rules with objective metrics.
 *
 * Statistical methods:
 *   - Linear regression of error vs range
 *   - Lag-1 autocorrelation for error correlation
 *   - Wald-Wolfowitz run test for randomness
 *   - Pattern classification (6 categories)
 *
 * @author J. Lighthall
 * @date February 2026
 * Adapted from reference/error_accumulation_analyzer.h
 */

#ifndef TL_ANALYSIS_H
#define TL_ANALYSIS_H
 ...
 *
 * Collects range-error pairs with associated TL values and significance
 * flags for subsequent statistical analysis.
 */
