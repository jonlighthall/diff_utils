...
int main(int argc, char* argv[]) {
  ...
  write_precision_file(base_filename + ".asc", pi, 0, max_decimal_places, 1);

  // Generate descending precision file
  write_precision_file(base_filename + ".desc", pi, max_decimal_places, 0, -1);
  ...
  std::cout << std::endl;
  std::cout << "Ascending file:  " << base_filename << ".asc" << std::endl;
  std::cout << "Descending file: " << base_filename << ".desc" << std::endl;
